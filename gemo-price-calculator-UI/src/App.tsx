...
function App() {
  ...
  const handleBeverageTypeChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    setBeverageType(event.target.value);
    updatePrice();
  }

  const handleWhipCreamChange = (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleChocolateSauceChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <div className="App">
      ...
      <div className="form-container">
        ...
        <div className="form-row">
          ...
          <select id="beverageType" name="beverageType" value={beverageType} onChange={handleBeverageTypeChange}>
        ...
        <div className="form-row">
          ...
          <input type="checkbox" id="whipCream" name="whipCream" checked={whipCream} onChange={handleWhipCreamChange} />
        </div>
  
        <div className="form-row">
          <label htmlFor="chocolateSauce">Add Chocolate Sauce:</label>
          <input type="number" id="chocolateSauce" name="chocolateSauce" min="0" max="6" value={chocolateSauce} onChange={handleChocolateSauceChange} />
        </div>
