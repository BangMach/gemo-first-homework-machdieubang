                ...
                for item in order:
                    if item == "Chocolate Sauce":
                        ...
                        if num_of_chocolate_pump <= 2:
                            ...
                            print("Chocolate Sauce: "  + str(priceDict["Chocolate Sauce"] ))          
                        else:
                            break 
        elif "Cold" in order:
...
print(calculatePrice5(["BasedMilktea","L", "Cold", "WhippedCream","Sandwich","Egg"])) # Output should be 7.75
print
print(calculatePrice5(["BasedMilktea","L", "Cold", "WhippedCream","Sandwich","Turkey"])) # Output should be 7.75

print(calculatePrice5(["BasedMilktea","L", "Cold", "WhippedCream","Bagel","Butter"])) # Output should be 7.75
print(calculatePrice5(["BasedMilktea","L", "Cold", "WhippedCream","Bagel","Cream Cheese"])) # Output should be 7.75
